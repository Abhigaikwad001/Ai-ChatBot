...
/**
 * REST controller for authenticated message retrieval and submission.
 */
@RestController
...
public class MessageController {
    ...
    /**
     * Submits a user message to the conversation.
     */
    @PostMapping
    ...
    /**
     * Streams an assistant response using Server-Sent Events (SSE).
    ...
    public ResponseEntity<SseEmitter> streamMessage(
        ...
        return ResponseEntity.ok()
            ...
            .body(chatService.streamMessage(conversationId, userId, request));
    }

    /**
     * Retrieves paginated messages for the conversation in sequential order.
     */
    @GetMapping
