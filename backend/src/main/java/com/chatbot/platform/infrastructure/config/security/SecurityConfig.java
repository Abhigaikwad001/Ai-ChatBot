...
/**
 * Minimal Spring Security configuration for the standalone no-auth chatbot.
 * Configures CORS, disables CSRF, enforces stateless sessions, and permits all requests.
 */
@Configuration
@EnableWebSecurity
